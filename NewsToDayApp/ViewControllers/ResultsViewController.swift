...
class ResultsViewController: UIViewController {
    ...
    var newsModel: JustReuseNewsModelView!
    ...
    private lazy var nameStateLabel: UILabel = {
       let label = UILabel()
        ...
        label.layer.shadowColor = UIColor(red: 0, green: 0, blue: 0, alpha: 0.7).cgColor
        label.layer.shadowOffset = CGSize(width: 5, height: 5)
        label.layer.shadowRadius = 5
        label.font = .systemFont(ofSize: 20, weight: .semibold)
        label.numberOfLines = 0
        label.backgroundColor = .categoryButtonColor
        label.translatesAutoresizingMaskIntoConstraints = false
        return label
    }()
...
extension ResultsViewController {
    private func setConstraints () {
        NSLayoutConstraint.activate([
            ...
            categoryView.topAnchor.constraint(equalTo: view.topAnchor, constant: 50),
            ...
            nameStateLabel.topAnchor.constraint(equalTo: categoryView.bottomAnchor, constant: 55),
            ...
            author.topAnchor.constraint(equalTo: authorLabel.bottomAnchor, constant: 20),
